...
import application.server.networking.CommandsServerToClient;
import application.server.networking.ServerOutput;
...
public class Lobby {
    ...
    public void startGame(Player player) {
        ...
        if (!playersInLobby.contains(player)) {
            ...
            status = "ongoing game";
            //GameManager.starter(playersInLobby); this is an arrayList, anisja uses an array
